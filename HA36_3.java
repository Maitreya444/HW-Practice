//Write a java code which accept N numbers from user and accept one another number as NO, and return index of last occurence of taht NO
//Input   : 6
//No      : 66
...
class NumberDemo
{
    ...
    {
        int iCnt = 0;
        for(iCnt = iNo.length-1; iCnt > 0 ; iCnt --)
        {
            if(iNo[iCnt] == iSee)
            {   
                return iCnt;
